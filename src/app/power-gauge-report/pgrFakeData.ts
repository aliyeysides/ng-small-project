...
const XL = {
  "EPSData": {
    ...
    "next_report_date": "Wed Jul 26",
    "revenue_12mo_pct_chg": "no data",
    "eps_12mo_pct_chg": "+47%",
    "last_report_date": "Wed Apr 26",
    "warning_factor": "",
    ...
    "warning_period": "",
    "warning_impact": "",
    "last_quarter_sales": "$2.75b",
    "last_quarter_reported_eps": "$0.50",
    "eps_diff_description": "beat by $0.04",
    "current_quarter_consensus_estimate": "$0.96",
    "warning_direction": 0,
    "eps_diff_category": 2,
    "warning_type": -1,
    "last_quarter_consensus_estimate": "$0.46",
    "time_icon_description": "",
    "revision_quarter": "1",
    "previous_revision_estimate": "$0.51",
...
const XLResearchData = {
  ...
  "Details": {
    ...
    "Address2": null,
    "StateCode": "D0",
    "EmployeesCount": "3818.0",
    "Address1": "ONE BERMUDIANA ROAD",
    "City": "HAMILTON",
    "URL": "http://www.xlgroup.com",
    "Profile": "XL Group Limited provides insurance and reinsurance coverage to industrial, commercial and professional service firms, insurance companies and other enterprises. The Company's operating segment consists of Insurance and Reinsurance. Insurance product segment includes Global Casualty, Global Energy Property, & Construction; Global Professional and Global Specialty. Reinsurance segment provides casualty, property risk, property catastrophe, specialty and other reinsurance lines. XL Group Limited, formerly known as XL Group plc, is based in Hamilton, Bermuda.",
    "CompanyName": "Xl Group Ltd",
    "FaxNumber": "353-1607-5333",
...
const XLStock = new Stock(XL.EPSData, XL.metaInfo, XL.pgr, XL.fundamentalData, XL.status);

export const PGRFAKEDATA: any[] = [XLStock, XLResearchData, XLContextSummary];
